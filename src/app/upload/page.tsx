    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mx-auto max-w-3xl">
        <div className="flex flex-col items-center text-center mb-8">
            ...
            <h1 className="text-4xl font-bold font-headline">Upload Your Research</h1>
          ...
          <CardContent>
            <form className="grid gap-6">
              <div className="grid gap-2">
                ...
                <Input id="title" placeholder="A Novel Approach to..." required />
              </div>
              <div className="grid gap-2">
                <Label htmlFor="authors">Authors</Label>
                <Input id="authors" placeholder="John Doe, Jane Smith" required />
                <p className="text-sm text-muted-foreground">Separate author names with a comma.</p>
              </div>
              <div className="grid gap-2">
              ...
              <div className="grid gap-2">
                ...
                <Input id="pdf-file" type="file" accept=".pdf" required className="pt-2" />
              </div>
              <div className="flex justify-end">
                <Button type="submit" size="lg">Upload Paper</Button>
              </div>
            </form>
          </CardContent>
        </Card>
